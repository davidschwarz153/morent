  ...
  const blogPosts = [
    {
      ...
      excerpt: "Entdecken Sie die neuesten Entwicklungen in der Elektromobilität und wie sie unsere Art zu reisen verändern wird.",
    ...
    },
    {
      ...
      excerpt: "Planen Sie Ihren nächsten Roadtrip mit unseren Expertentipps für eine unvergessliche Reise.",
      category: "reisen",
    ...
    },
    {
      ...
      excerpt: "Praktische Tipps, wie Sie durch bewusstes Autofahren die Umwelt schonen können.",
    ...
    },
    {
      ...
      excerpt: "Eine Übersicht der familienfreundlichsten Fahrzeuge mit Fokus auf Sicherheit und Komfort.",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto py-12 px-4">
        ...
        <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
          Entdecken Sie interessante Artikel über Fahrzeuge, Mobilität und nachhaltiges Reisen.
        </p>
