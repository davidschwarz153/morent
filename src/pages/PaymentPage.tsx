...
import { Vehicle, getVehicleById } from '../lib/supabase';
...
export default function PaymentPage() {
  ...
  const handlePaymentMethodChange = (method: 'credit' | 'paypal' | 'bitcoin') => {
  ...
  const nextStep = () => {
    if (currentStep === 'billing') setCurrentStep('rental');
    else if (currentStep === 'rental') setCurrentStep('payment');
    else if (currentStep === 'payment') setCurrentStep('confirmation');
    else if (currentStep === 'confirmation') completeRental();
  };
  ...
  const completeRental = () => {
    // Hier würden wir normalerweise die Buchung an die API senden
    alert('Buchung abgeschlossen! Vielen Dank für Ihre Bestellung.');
    navigate('/');
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto py-6 px-4">
        <div className="mb-6">
          <Link to={`/cars/${id}`} className="flex items-center text-gray-600 hover:text-blue-600 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            {/* Billing Info */}
            <div className={`bg-white rounded-lg p-6 shadow-sm mb-6 ${currentStep !== 'billing' ? 'opacity-60' : ''}`}>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">Billing Info</h2>
                <span className="text-sm text-gray-500">Step {getStepNumber('billing')} of 4</span>
              </div>
              <p className="text-sm text-gray-500 mb-4">Bitte geben Sie Ihre Rechnungsdaten ein</p>
              ...
              {currentStep === 'billing' && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="town" className="block text-sm font-medium text-gray-700 mb-1">Stadt / Ort</label>
                      <input
                        type="text"
                        id="town"
                        name="town"
            ...
            {/* Rental Info */}
            <div className={`bg-white rounded-lg p-6 shadow-sm mb-6 ${currentStep !== 'rental' ? 'opacity-60' : ''}`}>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">Rental Info</h2>
                <span className="text-sm text-gray-500">Step {getStepNumber('rental')} of 4</span>
              </div>
              <p className="text-sm text-gray-500 mb-4">Bitte wählen Sie Ihre Mietdaten</p>
              ...
              {currentStep === 'rental' && (
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="pickupLocation" className="block text-sm font-medium text-gray-700 mb-1">Ort</label>
                        <select
                          id="pickupLocation"
                          name="pickupLocation"
                          className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      ...
                      <div>
                        <label htmlFor="pickupDate" className="block text-sm font-medium text-gray-700 mb-1">Datum</label>
                        <input
                          type="date"
                          id="pickupDate"
                          name="pickupDate"
                    ...
                    <div className="mt-3">
                      <label htmlFor="pickupTime" className="block text-sm font-medium text-gray-700 mb-1">Zeit</label>
                      <input
                        type="time"
                        id="pickupTime"
                        name="pickupTime"
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="dropoffLocation" className="block text-sm font-medium text-gray-700 mb-1">Ort</label>
                        <select
                          id="dropoffLocation"
                      ...
                      <div>
                        <label htmlFor="dropoffDate" className="block text-sm font-medium text-gray-700 mb-1">Datum</label>
                        <input
                          type="date"
                          id="dropoffDate"
                          name="dropoffDate"
                    ...
                    <div className="mt-3">
                      <label htmlFor="dropoffTime" className="block text-sm font-medium text-gray-700 mb-1">Zeit</label>
                      <input
                        type="time"
                        id="dropoffTime"
                        name="dropoffTime"
            ...
            {/* Payment Method */}
            <div className={`bg-white rounded-lg p-6 shadow-sm mb-6 ${currentStep !== 'payment' ? 'opacity-60' : ''}`}>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">Payment Method</h2>
                <span className="text-sm text-gray-500">Step {getStepNumber('payment')} of 4</span>
              </div>
              <p className="text-sm text-gray-500 mb-4">Bitte wählen Sie Ihre Zahlungsmethode</p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center p-3 border rounded-lg cursor-pointer transition-colors hover:bg-gray-50">
                      <input 
                        ...
                        className="mr-3"
                      />
                      <label htmlFor="credit" className="flex-grow cursor-pointer">Credit Card</label>
                    ...
                    <div className="flex items-center p-3 border rounded-lg cursor-pointer transition-colors hover:bg-gray-50">
                      <input 
                        ...
                        className="mr-3"
                      />
                      <label htmlFor="bitcoin" className="flex-grow cursor-pointer">Bitcoin</label>
            ...
            {/* Confirmation */}
            <div className={`bg-white rounded-lg p-6 shadow-sm mb-6 ${currentStep !== 'confirmation' ? 'opacity-60' : ''}`}>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">Confirmation</h2>
                <span className="text-sm text-gray-500">Step {getStepNumber('confirmation')} of 4</span>
              </div>
              <p className="text-sm text-gray-500 mb-4">Fast geschafft! Nur noch ein paar Klicks und Ihre Buchung ist abgeschlossen.</p>
              ...
              {currentStep === 'confirmation' && (
                <div className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <label htmlFor="marketing" className="text-sm text-gray-700">
                        Ich stimme dem Erhalt von Marketing und Newsletter E-Mails zu. Kein Spam, versprochen!
                      </label>
                    </div>
                  ...
                  <div className="border rounded-lg p-4 bg-blue-50 flex items-start">
                    ...
                    <div>
                      <p className="text-sm font-medium">Alle Ihre Daten sind sicher</p>
                      <p className="text-xs text-gray-600">Wir verwenden modernste Sicherheitsvorkehrungen, um Ihnen das beste Erlebnis zu bieten.</p>
                    </div>
                  </div>
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-xs text-gray-500 ml-1">5 Bewertungen</span>
                  </div>
                </div>
              </div>
