        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-64">
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="mb-6">
                <h3 className="uppercase text-xs font-semibold text-gray-500 tracking-wider mb-3">TYPE</h3>
                <div className="space-y-2">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="type-sport" className="ml-2 text-sm">Sport (10)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="type-suv" className="ml-2 text-sm">SUV (12)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="type-mpv" className="ml-2 text-sm">MPV (16)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="type-sedan" className="ml-2 text-sm">Sedan (20)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="type-coupe" className="ml-2 text-sm">Coupe (14)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="type-hatchback" className="ml-2 text-sm">Hatchback (14)</label>
                  </div>
                </div>
              </div>
              
              <div className="mb-6">
                <h3 className="uppercase text-xs font-semibold text-gray-500 tracking-wider mb-3">CAPACITY</h3>
                <div className="space-y-2">
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="capacity-2" className="ml-2 text-sm">2 Person (10)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="capacity-4" className="ml-2 text-sm">4 Person (14)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="capacity-6" className="ml-2 text-sm">6 Person (12)</label>
                  </div>
                  <div className="flex items-center">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <label htmlFor="capacity-8" className="ml-2 text-sm">8 or More (16)</label>
                  </div>
                </div>
              </div>
              
              <div className="mb-6">
                <h3 className="uppercase text-xs font-semibold text-gray-500 tracking-wider mb-3">PRICE</h3>
                <div className="px-1">
                  <input 
                    type="range" 
                    min="0" 
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <span className="text-sm text-gray-800">Max ${filters.maxPrice}.00</span>
                  </div>
                </div>
              </div>
            </div>
