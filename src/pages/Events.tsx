  ...
  const events = [
    {
      ...
      description: "Entdecken Sie die neuesten Fahrzeugmodelle und exklusive Angebote von Morent.",
      category: "show",
    ...
    },
    {
      ...
      description: "Lernen Sie alles über die Zukunft der Elektromobilität und unsere E-Fahrzeugflotte.",
      category: "workshop",
    ...
    },
    {
      ...
      description: "Netzwerken Sie mit anderen Morent-Nutzern und teilen Sie Ihre Erfahrungen.",
      category: "community",
    ...
    },
    {
      ...
      description: "Professionelle Tipps zur Pflege und Wartung Ihres Mietfahrzeugs.",
      category: "seminar",
      ...
      <main className="container mx-auto py-12 px-4">
        ...
        {filteredEvents.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500">Keine Veranstaltungen in dieser Kategorie gefunden.</p>
          </div>
        )}

        <div className="mt-16 bg-white p-8 rounded-lg shadow-sm">
          <h2 className="text-2xl font-bold mb-6 text-center">Veranstaltung vorschlagen</h2>
