...
import { FaPlay, FaPause, FaClock, FaCalendarAlt, FaMicrophone, FaSpotify, FaApple, FaRss } from "react-icons/fa";
  ...
  const episodes = [
    {
      ...
      description: "In dieser Episode sprechen wir mit Experten über die Zukunft der Elektromobilität und ihre Auswirkungen auf unseren Alltag.",
      duration: "45:30",
      date: "15. Mai 2025",
    ...
    },
    {
      ...
      description: "Wir diskutieren die neuesten Entwicklungen im Bereich des autonomen Fahrens und was das für die Zukunft der Mobilität bedeutet.",
      duration: "38:15",
      date: "1. Mai 2025",
      host: "Michael Weber",
    ...
    },
    {
      ...
      description: "Praktische Tipps und Erfahrungsberichte, wie Sie Ihren Mobilitätsalltag nachhaltiger gestalten können.",
      duration: "42:00",
      date: "15. April 2025",
      host: "Lisa Müller",
      image: "https://images.unsplash.com/photo-1507136566006-cfc505b114fc?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
    },
    {
      id: 4,
      title: "Die Zukunft der Sharing Economy",
      description: "Wie verändert die Sharing Economy unsere Art der Fortbewegung? Eine Analyse aktueller Trends und Entwicklungen.",
      duration: "36:45",
      date: "1. April 2025",
      host: "Thomas Becker",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto py-12 px-4">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold mb-4">Morent Podcast</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Tauchen Sie ein in spannende Gespräche über Mobilität, Technologie und Nachhaltigkeit.
            Jeden zweiten Mittwoch eine neue Episode.
          </p>
          ...
          {episodes.map(episode => (
            <div 
              ...
              className={`bg-white rounded-lg shadow-sm overflow-hidden ${
                activeEpisode === episode.id ? 'ring-2 ring-blue-500' : ''
              }`}
            >
        ...
        <div className="mt-12 bg-white p-8 rounded-lg shadow-sm text-center">
          <h2 className="text-2xl font-bold mb-4">Verpassen Sie keine Episode!</h2>
          <p className="text-gray-600 mb-6">
            Abonnieren Sie unseren Newsletter und erhalten Sie Benachrichtigungen über neue Episoden.
          </p>
