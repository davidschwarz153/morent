    ...
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-medium mb-4 dark:text-white">Community</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/events"
          ...
          <div>
            <h3 className="font-medium mb-4 dark:text-white">Socials</h3>
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  className="text-gray-600 dark:text-gray-300 hover:text-blue-500 text-sm flex items-center"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between mt-10 pt-6 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-300">
