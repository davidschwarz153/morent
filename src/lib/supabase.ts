...
if (!supabaseUrl) {
  throw new Error(
    "VITE_SUPABASE_URL ist nicht definiert. Bitte überprüfen Sie Ihre Umgebungsvariablen."
  );
}

if (!supabaseAnonKey) {
  throw new Error(
    "VITE_SUPABASE_ANON_KEY ist nicht definiert. Bitte überprüfen Sie Ihre Umgebungsvariablen."
  );
}
